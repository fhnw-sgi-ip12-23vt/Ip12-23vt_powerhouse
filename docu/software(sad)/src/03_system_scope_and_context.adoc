...
image::fachlicher_kontext.drawio.png["Bild: Fachlicher Kontext von Powerhouse"]

**<optional: Erläuterung der externen fachlichen Schnittstellen>**

==== Menschlicher Spieler (Benutzer)

Powerhouse wird von einem Spieler gespielt. Powerhouse leitet den Spieler durch das Spiel. Dabei nimmt das System die Antworten und Entscheidungen des Spielers entgegen.

==== Fremdsysteme

Das System kommuniziert mit keinen Fremdsystemen. (Eventuell Build System?)
